...
checkpoint:
  ...
  gray_areas_resolved:
    ...
    - topic: "primary persona scope"
      decision: "intermediate climber"
    - topic: "core insight"
      decision: "generic climbing plans do not target the specific weaknesses of a given climber"
    - topic: "auth strategy"
      decision: "login with an account"
    - topic: "role model"
      decision: "single flat user role for MVP"
    - topic: "mvp scope discipline"
      decision: "scope down to a simple questionnaire with 1-2 questions and a generic plan based on the answers"
    - topic: "mvp questions"
      decision: "injury or body-part strengthening focus, and finger strength"
    - topic: "primary success criterion"
      decision: "user can log in and receive a usable weekly plan in under 2 minutes"
    - topic: "mvp delivery estimate"
      decision: "1 week"
    - topic: "fr priority"
      decision: "all MVP functional requirements are must-have"
    - topic: "socrates adjustments"
      decision: "remove email confirmation from MVP; narrow questionnaire to injury and climbing grade proxy"
    - topic: "product type"
      decision: "web app"
    - topic: "target scale"
    ...
    - topic: "scale challenge"
      decision: "the core rule would not change at 100x usage"
    - topic: "non-goals"
      decision: "exclude long-term cycles, analytics, social features, external integrations, dedicated mobile app, and advanced exercise video library from MVP"
  frs_drafted: 9
...
- Scale note: the core rule would not change at 100x usage
- Hard deadline: 2026-05-31
- Delivery mode: after-hours only
